      ...
      <header className="">
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-row space-x-0">
            <div className="px-6 py-2 text-sm font-medium text-[#d36360] hover:bg-[#bd4143] hover:text-white rounded-full ">
          ...
          <div className="flex flex-row space-x-3">
            <div className="inline-flex items-center justify-center w-8 h-8 bg-[#d36360] rounded-full text-white shadow-md shadow-rose-500/20">
              <NavLink tag={Link} className="" to="/">
                <MdNotifications />
              </NavLink>
            </div>
