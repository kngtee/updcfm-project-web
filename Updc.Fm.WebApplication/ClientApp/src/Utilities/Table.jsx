...
<div class="relative overflow-x-auto  shadow-md md:rounded-lg">
    <table class="w-[800px] rounded-t-lg text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody >
        {data.map((row) => (
          <tr class="bg-white odd:bg-gray-100 ... border-b  justify-center" key={row.id}>
